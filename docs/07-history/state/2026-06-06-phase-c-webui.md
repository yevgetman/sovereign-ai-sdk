...
**Predecessor:** [`docs/07-history/state/2026-06-05-phase-b-transport.md`](2026-06-05-phase-b-transport.md) (Phase B — Multi-Client Session Transport shipped + hardened; v0.6.19).
...
- **Roadmap:** [`specs/2026-06-05-run-anywhere-harness-roadmap-design.md`](specs/2026-06-05-run-anywhere-harness-roadmap-design.md) (the program; A–F; A + B + C now marked shipped)
- **Spec:** [`specs/2026-06-05-phase-c-reference-web-ui-design.md`](specs/2026-06-05-phase-c-reference-web-ui-design.md) (decisions D1–D8)
- **Plan:** [`plans/2026-06-05-phase-c-reference-web-ui.md`](plans/2026-06-05-phase-c-reference-web-ui.md)
...
- **Real-browser e2e** — Playwright against a live gateway + real model, 3 legs PASS (above). Logged in `docs/06-testing/testing-log.md`.
