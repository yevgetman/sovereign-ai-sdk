...
**Scope:** every subsystem in the [subsystems atlas](docs/02-architecture/subsystems-overview.md) — all 17 regions, ~56k LoC TypeScript + the Go TUI + `bundle-default/` + release tooling. Holistic cross-cutting passes for data-leakage, resource-lifecycle, and cross-seam consistency.
