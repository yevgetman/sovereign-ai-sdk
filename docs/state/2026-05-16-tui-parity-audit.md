...
**Predecessor spec:** [`docs/specs/2026-05-16-phase-16-1-m10-parity-audit-design.md`](../specs/2026-05-16-phase-16-1-m10-parity-audit-design.md)
...
**Real-Anthropic verification:** Smoke Agent B's transcript at `docs/state/2026-05-16-tui-parity-audit-soak/agent-b-harness-info.transcript.txt` shows the model invoking HarnessInfo with the snapshot returning accurate runtime state (0 MCP servers, default permission mode, etc.).
...
All 4 pass. Transcripts at `docs/state/2026-05-16-tui-parity-audit-soak/`.
