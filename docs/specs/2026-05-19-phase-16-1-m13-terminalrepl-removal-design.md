...
**Predecessor:** [M12 close-out snapshot](../state/2026-05-19-m12.md) — REPL deprecation warning shipped; suite green at 2073/2073; 6/6 smoke pass.
...
- Update `CLAUDE.md` boot block, `README.md`, `docs/usage.md` to drop REPL references.
...
- New state snapshot `docs/state/YYYY-MM-DD-m13.md`.
...
Save outputs to `docs/state/YYYY-MM-DD-m13-smoke/` with a README summarizing.
