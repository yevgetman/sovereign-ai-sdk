...
**Predecessor:** [M10.5 close-out snapshot](../state/2026-05-16-m10-5.md) — slash dispatcher shipped; backlog #40 closed; **M11 unblocked**.
...
- Read the M10 parity audit report (`docs/state/2026-05-16-tui-parity-audit.md`).
- Read M10.5's close-out (`docs/state/2026-05-16-m10-5.md`) + the dispatcher commits (`17d456b`, `d515b9f`).
...
Output: `docs/state/2026-05-17-m11-parity-audit.md`.
...
Capture stdout + stderr to `docs/state/2026-05-17-m11-smoke/`. Sanitize keys.
...
- **`docs/usage.md`** — update flag description there too.
- **`CLAUDE.md`** + **`AGENTS.md`** — update the state-pointer line to reference `docs/state/2026-05-17-m11.md`. Verify byte-identical mirror.
- **`docs/state/2026-05-17-m11.md`** — new close-out snapshot following the M10.5 template structure.
- **`docs/backlog/post-phase-13-4.md`** — update the sync header line; add any new items uncovered during audit (likely none if audit is clean).
...
4. **`docs: M11 — update README + usage.md for default-flip`** — README + `docs/usage.md`
5. **`docs: M11 close-out — parity audit, smoke, state snapshot, ADRs`** — audit report, smoke transcripts, `docs/state/2026-05-17-m11.md`, ADRs M11-01..N, backlog updates, CLAUDE.md/AGENTS.md pointer
...
Per [`docs/conventions/estimation.md`](../conventions/estimation.md): sessions / dispatches / wall-minutes, never weeks.
