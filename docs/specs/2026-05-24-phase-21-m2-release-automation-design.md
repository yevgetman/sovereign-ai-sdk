...
5. Update to `docs/conventions/cutting-releases.md` documenting the new tag-push-driven flow + the local fallback.
6. New state snapshot at `docs/state/YYYY-MM-DD-phase-21-m2.md` once shipped.
7. One ADR in `DECISIONS.md` covering the cross-repo upload token model (P21-C).
8. Close backlog `#48` in `docs/backlog/post-phase-13-4.md`.
...
- ~30 min — write state snapshot; close backlog `#48`; update `docs/conventions/cutting-releases.md`
...
**Next step:** invoke `superpowers:writing-plans` to produce the executable implementation plan at `docs/plans/2026-05-24-phase-21-m2-release-automation.md`. Plan execution follows in the same session per the autonomous-proceed directive.
