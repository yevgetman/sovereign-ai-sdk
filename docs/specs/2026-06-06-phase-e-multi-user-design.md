...
**Parent roadmap:** `docs/specs/2026-06-05-run-anywhere-harness-roadmap-design.md` (Phase E / modules M4 + M5). **Depends on Phase A** (gateway auth, v0.6.18) **+ Phase D** (session supervisor, v0.6.21).
