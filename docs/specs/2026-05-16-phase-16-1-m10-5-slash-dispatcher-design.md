...
**Predecessor:** M10 audit (`docs/state/2026-05-16-tui-parity-audit.md`) §"What's open / blockers for M11"; backlog item #40.
...
|---|---|
| Spec | This file |
| Plan | `docs/plans/2026-05-16-phase-16-1-m10-5-slash-dispatcher.md` |
...
| State snapshot | `docs/state/2026-05-16-m10-5.md` |
| Testing-log entry | `docs/testing-log.md` (newest-first) |
