...
**Predecessor:** M11 default-flip (`docs/state/2026-05-17-m11.md`); also depends on M10.5 dispatcher route (`docs/specs/2026-05-16-phase-16-1-m10-5-slash-dispatcher-design.md`).
