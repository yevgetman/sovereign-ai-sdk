...
- `docs/06-testing/testing-log.md` - Post-Fix Real-World Website REPL Retest

## Completion Summary

- Status: complete as of 2026-04-28.
- Items 1 through 7 are closed with implementation notes and validation
  evidence in this document and in `docs/06-testing/testing-log.md`.
...
- Priority: P3
- Status: complete (2026-04-27)
- Fix: Updated `README.md` and `docs/03-cli-reference/usage.md` to document the current
...
- Evidence: `src/main.ts` now sets `DEFAULT_MAX_TOKENS = 12000`, but
  `README.md` and `docs/03-cli-reference/usage.md` still say the default is `4096`.
