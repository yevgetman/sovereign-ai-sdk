...
- **The analysis behind it:** `~/code/sovereign-ai-docs/state/analysis/2026-06-03-deepagents-vs-harness-build-vs-adopt.md`
...
3. **Author the implementation specs + build plans in THIS repo**, per `docs/conventions/repo-layout.md`:
   - a **design doc** under `docs/specs/` for the four-port contract and how each port binds to this harness (adapter #1);
   - a **Phase 1 implementation plan** under `docs/plans/` (close Recall; fix synthesis yield; build the with-vs-without eval), task-checkboxed for `superpowers:subagent-driven-development`.
