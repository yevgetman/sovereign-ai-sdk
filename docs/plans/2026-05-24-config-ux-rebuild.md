...
**Spec:** [`docs/specs/2026-05-24-config-ux-rebuild-design.md`](../specs/2026-05-24-config-ux-rebuild-design.md)
...
- Run `bun run release v0.5.1` (per `docs/conventions/cutting-releases.md`).

### T12 — Close-out (depends on T11)
- Write `docs/state/2026-05-24-config-ux-rebuild.md` close-out snapshot.
- Append entry to `docs/testing-log.md`.
...
Per `docs/conventions/lint-and-commit.md`: `bun run lint && bun run typecheck && bun run test`. Skip semantic and Go-side suites per-commit; run them at T9.
