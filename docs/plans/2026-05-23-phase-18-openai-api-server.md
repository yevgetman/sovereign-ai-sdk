...
**Files:**
- Create: `docs/state/2026-05-23-phase-18-openai-api-server.md`, `scripts/openai-smoke.py` (manual smoke, not CI).
- Modify: `CLAUDE.md` + `AGENTS.md` (byte-identical), `docs/testing-log.md`, `DECISIONS.md` (record relevant Ds).
