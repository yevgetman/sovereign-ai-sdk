...
**Spec references:**
- `docs/specs/2026-05-16-phase-16-1-m9-5-theme-polish-design.md` (the spec this plan implements)
- `docs/specs/2026-05-16-phase-16-1-m9-visual-polish-design.md` §ADR M9-03 (TOML loader deferral being closed)
- `docs/state/2026-05-16.md` §"What does NOT work" (M9.5 scope source)
...
| `docs/backlog/post-phase-13-4.md` | T4 — no items to close (M9.5 doesn't close backlog items); note M9.5 completion in narrative if relevant |
| `DECISIONS.md` | T4 — add ADRs M9.5-01, M9.5-02, M9.5-03 |
| `docs/state/2026-05-16.md` | T4 — supersede with M9.5 close-out snapshot (move current to archive) |
| `docs/state/archive/2026-05-16-m9.md` | T4 — archive of the M9 snapshot (rename from current docs/state/2026-05-16.md) |
| `CLAUDE.md` / `AGENTS.md` | T4 — update state pointer to M9.5 snapshot; byte-identical mirror |
| `docs/testing-log.md` | T4 — append M9.5 close-out entry |
...
- Modify: `DECISIONS.md`, `CLAUDE.md`, `AGENTS.md`, `docs/testing-log.md`
- Move: `docs/state/2026-05-16.md` → `docs/state/archive/2026-05-16-m9.md` (or similar)
- Create: `docs/state/2026-05-16-m9-5.md` (or replace existing 2026-05-16.md)
...
```bash
git mv docs/state/2026-05-16.md docs/state/archive/2026-05-16-m9.md
```

Write new `docs/state/2026-05-16.md` covering M9.5: HEAD SHA, suite counts, what shipped per task, ADRs, behavioral notes, postmortem-rule check, what's open / next.
...
```bash
git add packages/tui/internal/theme/integration_test.go DECISIONS.md docs/state/ CLAUDE.md AGENTS.md docs/testing-log.md
...
- [ ] State snapshot at `docs/state/2026-05-16.md` covers M9.5.
