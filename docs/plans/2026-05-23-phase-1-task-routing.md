...
**Goal:** Ship Phase 1 of multi-provider task routing per the design at `docs/specs/2026-05-23-multi-provider-task-routing-design.md`. Defaults provide a B-via-D bridge baseline (cost-lane sub-agents available even when disabled); `taskRouting.enabled: true` activates the delegator + decomposition flow.
...
| `docs/state/2026-05-23-phase-1-task-routing.md` | Phase 1 close-out snapshot. |
...
| `docs/usage.md` | Add "Multi-provider task routing" section. |
| `docs/testing-log.md` | Append Phase 1 entry. |
...
- Create: `docs/state/2026-05-23-phase-1-task-routing.md`.
- Modify: `CLAUDE.md`, `AGENTS.md` (byte-identical mirror).

- [ ] **Step 1: Add `docs/usage.md` section**
...
- [ ] **Step 2: Create `docs/state/2026-05-23-phase-1-task-routing.md`**

Mirror the structure of `docs/state/2026-05-22-phase-17-cron.md`. Sections:
...
In the "Session boot" section's "most recent close-out snapshot" line, update from `docs/state/2026-05-23-phase-18-openai-api-server.md` to `docs/state/2026-05-23-phase-1-task-routing.md`. Add a new row at the top of the "Current state" table.
...
```bash
git add docs/usage.md docs/state/2026-05-23-phase-1-task-routing.md CLAUDE.md AGENTS.md
