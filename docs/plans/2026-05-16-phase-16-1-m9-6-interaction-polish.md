...
**Spec references:**
- `docs/specs/2026-05-16-phase-16-1-m9-6-interaction-polish-design.md` (the spec this plan implements)
- `docs/state/2026-05-16.md` §"What does NOT work" (M9.6 scope source)
...
| `docs/state/2026-05-16.md` | T5 — replace with M9.6 close-out (move M9.5 to archive) |
| `docs/state/archive/2026-05-16-m9-5.md` | T5 — archive of M9.5 snapshot |
| `CLAUDE.md` / `AGENTS.md` | T5 — update state pointer; byte-identical mirror |
| `docs/testing-log.md` | T5 — append M9.6 close-out entry |
...
```bash
git mv docs/state/2026-05-16.md docs/state/archive/2026-05-16-m9-5.md
```

Write new `docs/state/2026-05-16.md` covering M9.6: HEAD SHA, suite counts, what shipped per task, ADRs, behavioral notes, postmortem-rule check, what's open / next.
...
```
git add packages/tui/internal/app/m9Full_test.go DECISIONS.md docs/state/ CLAUDE.md AGENTS.md docs/testing-log.md
...
- [ ] State snapshot at `docs/state/2026-05-16.md` covers M9.6.
