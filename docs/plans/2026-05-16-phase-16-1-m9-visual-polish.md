...
**Spec references:**
- `docs/specs/2026-05-16-phase-16-1-m9-visual-polish-design.md` (M9 design — the spec this plan implements)
- `docs/specs/2026-05-13-phase-16-1-tui-rebuild-design.md` §10 (M9 milestone row)
- `docs/backlog/post-phase-13-4.md` items #29 (lipgloss `Style.Copy()`), #39 (Go mirror for `SessionSummaryEvent`)
- `docs/postmortems/2026-05-12-phase-16-revert.md` Rules 1–4
- `docs/plans/2026-05-16-phase-16-1-m8-polish-surfaces.md` (M8 plan — reference pattern)
...
| `docs/backlog/post-phase-13-4.md` | T12 — close #29 (lipgloss `Style.Copy()`) and #39 (Go mirror for SessionSummaryEvent) |
| `DECISIONS.md` | T12 — add ADRs M9-01 through M9-12 |
| `docs/state/2026-05-XX.md` | T12 — new close-out snapshot (supersedes 2026-05-16) |
| `docs/state/archive/2026-05-16.md` | T12 — archive the M8 close-out snapshot |
| `CLAUDE.md` / `AGENTS.md` | T12 — update state-snapshot pointer; byte-identical mirror preserved |
| `docs/testing-log.md` | T12 — append M9 close-out entries |
...
| T12 | `docs/backlog/post-phase-13-4.md`, `DECISIONS.md`, `CLAUDE.md`, `AGENTS.md`, `docs/testing-log.md`, `docs/state/archive/2026-05-16.md` (move), `docs/state/2026-05-XX.md` (new) | `tests/server/m9Full.test.ts`, `packages/tui/internal/app/m9Full_test.go` | both new |
...
- Modify: `docs/backlog/post-phase-13-4.md` (close #29 and #39 in T12, but verify the work landed in T11)
...
- Modify: `docs/backlog/post-phase-13-4.md` (close #29 and #39)
- Modify: `DECISIONS.md` (12 new ADR stubs M9-01 to M9-12)
- Move: `docs/state/2026-05-16.md` → `docs/state/archive/2026-05-16.md`
- Create: `docs/state/2026-05-XX.md` (new close-out snapshot, date = today's commit date)
- Modify: `CLAUDE.md` + `AGENTS.md` (update state-snapshot pointer; byte-identical mirror)
- Append: `docs/testing-log.md` (M9 close-out entries)
...
- [ ] **Step 4 — Update `docs/backlog/post-phase-13-4.md`**
...
```bash
git mv docs/state/2026-05-16.md docs/state/archive/2026-05-16.md
```

Write a new `docs/state/2026-05-XX.md` (close-out date) following the M8 snapshot template — header with HEAD SHA + suite counts + lint/typecheck status, what shipped section per task, ADRs added, what's open/next, behavioral notes, postmortem-rule compliance check, link to next milestone (M10 parity audit).
...
- [ ] **Step 8 — Append to `docs/testing-log.md`**
...
Per `docs/conventions/sov-upgrade.md`:
...
```
git add docs/backlog/post-phase-13-4.md DECISIONS.md CLAUDE.md AGENTS.md docs/state/2026-05-XX.md docs/state/archive/2026-05-16.md docs/testing-log.md tests/server/m9Full.test.ts packages/tui/internal/app/m9Full_test.go
...
- [ ] State snapshot at `docs/state/2026-05-XX.md` exists and is referenced from CLAUDE.md.
- [ ] Testing log entries for each task in `docs/testing-log.md`.
