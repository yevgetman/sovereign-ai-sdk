...
- [`docs/02-architecture/runtime-architecture.md`](docs/02-architecture/runtime-architecture.md) — how these principles manifest in the request lifecycle.
- [`docs/02-architecture/subsystems-overview.md`](docs/02-architecture/subsystems-overview.md) — the component atlas the principles hold across.
- [`docs/04-extending/extending.md`](docs/04-extending/extending.md) — extension recipes that must respect the fail-closed / uniform-tool rules.
