...
2. Plan — writing-plans skill produces `plans/2026-05-23-multi-provider-task-routing.md` after this spec is approved.
3. Subagent-driven implementation, per `docs/05-conventions/subagent-policy.md`:
...
5. Atomic commits, autonomous push to master per `docs/05-conventions/lint-and-commit.md`.
6. Cut a binary release in the same session when runtime code changes, per `docs/05-conventions/cutting-releases.md`.
