...
> steps. Executes per `docs/05-conventions/autonomous-feature-builds.md`; model per
> `docs/05-conventions/subagent-policy.md` (Opus — touches `src/providers/`). Read the cited files
> first, then TDD (`bun run test`, `bun run lint`, `bun run typecheck`). Design:
> `specs/2026-06-08-sov-provider-design.md`.
...
- [ ] `docs/06-testing/testing-log.md` updated per `docs/05-conventions/testing-log.md`.
