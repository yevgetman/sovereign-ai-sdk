...
**Spec:** `specs/2026-06-09-effort-reasoning-depth-design.md`
...
**Files:** `tests/semantic/suites/NN-effort.cases.ts` (next free number), `docs/03-cli-reference/usage.md`, `docs/02-architecture/runtime-architecture.md`, `docs/04-extending/extending.md` (if a new seam warrants), `docs/06-testing/testing-log.md`.
