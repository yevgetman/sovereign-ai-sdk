...
- `docs/03-cli-reference/usage.md` — same. Likely line in flag table.
...
**Files:**
- `docs/07-history/state/2026-05-17-m11.md` — new close-out snapshot following the M10.5 template
- `docs/07-history/state/2026-05-17-m11-parity-audit.md` — audit report from T5
- `docs/07-history/state/2026-05-17-m11-smoke/**` — smoke transcripts from T6
...
- `docs/08-roadmap/backlog/post-phase-13-4.md` — update the sync header to "2026-05-17 — M11 close-out" with list of still-open items; archive M10/M10.5 markers
- `CLAUDE.md` — update the state-pointer line(s) in the session-boot section + standing rules table to reference `docs/07-history/state/2026-05-17-m11.md`
