...
- Docs: `docs/03-cli-reference/usage.md` (a `/plugins` section — install/consent/opt-in + the honest CC-import note + "v1 = skills+commands; agents/MCP/hooks are disclosed+deferred"), `docs/02-architecture/runtime-architecture.md` (the plugin layer + the consent/integrity model), `docs/04-extending/extending.md` (authoring a plugin). Append `docs/06-testing/testing-log.md`.
