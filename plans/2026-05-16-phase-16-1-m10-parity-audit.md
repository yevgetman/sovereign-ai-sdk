...
**Spec:** [`specs/2026-05-16-phase-16-1-m10-parity-audit-design.md`](specs/2026-05-16-phase-16-1-m10-parity-audit-design.md)
...
- **T1.2** Draft the 7-agent soak prompt set in `docs/07-history/state/2026-05-16-tui-parity-audit-soak/PROMPTS.md`. Categories mirror 2026-05-07.
...
- **T3.2** Write signed-off report at `docs/07-history/state/2026-05-16-tui-parity-audit.md`. Include:
...
- **T3.4** Update:
  - `docs/07-history/state/2026-05-16-m10.md` — new state snapshot (M10 close-out)
  - `CLAUDE.md` + `AGENTS.md` — state-snapshot pointer + session-boot reading list
  - `docs/06-testing/testing-log.md` — testing-log entry (newest-first)
  - `docs/08-roadmap/backlog/phase-16-rebuild-prereqs.md` — header reflects M10 close-out
  - `docs/08-roadmap/backlog/post-phase-13-4.md` — any new MEDIUM/LOW backlog items
...
- **T4.4** Commit work in atomic logical chunks per `docs/05-conventions/lint-and-commit.md`:
  1. Spec + plan commit
