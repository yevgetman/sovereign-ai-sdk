...
- `docs/07-history/state/2026-05-22-phase-17-cron.md` — close-out snapshot.
...
- `docs/06-testing/testing-log.md` — append entry per testing pass.
...
```bash
bun run lint && bun run typecheck && bun run test
git add tests/cron/smoke.test.ts docs/06-testing/testing-log.md
...
**Files:** Create `docs/07-history/state/2026-05-22-phase-17-cron.md`; update `CLAUDE.md` + `AGENTS.md` (byte-identical) with a cron pointer; update `docs/06-testing/testing-log.md`.

- [ ] **Step 1** — Write `docs/07-history/state/2026-05-22-phase-17-cron.md` covering: what shipped, architecture decisions, test counts, follow-ups (R1–R5 above), and how to use `sov cron`.
...
```bash
git add docs/07-history/state/2026-05-22-phase-17-cron.md CLAUDE.md AGENTS.md docs/06-testing/testing-log.md
...
Per `docs/05-conventions/cutting-releases.md` — any session that touches `src/` cuts the next release. This phase introduces a major feature; bump minor to v0.3.0 (not patch).
