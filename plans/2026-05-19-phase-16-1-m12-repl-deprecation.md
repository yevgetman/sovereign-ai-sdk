...
**Spec:** [`specs/2026-05-19-phase-16-1-m12-repl-deprecation-design.md`](specs/2026-05-19-phase-16-1-m12-repl-deprecation-design.md)
...
- `docs/03-cli-reference/usage.md` — similar treatment.
...
**Files:**
- `docs/07-history/state/2026-05-19-m12-smoke/` (new directory).
- `docs/07-history/state/2026-05-19-m12-smoke/run-smoke.ts` (new, copy-and-extend from `docs/07-history/state/2026-05-17-m11-smoke/run-smoke.ts`).
- `docs/07-history/state/2026-05-19-m12-smoke/*.transcript.txt` (captured outputs).
- `docs/07-history/state/2026-05-19-m12-smoke/README.md` (summary table).
...
**Files:**
- `docs/07-history/state/2026-05-19-m12.md` (new) — close-out snapshot mirroring M11/M11.5 format. Scope, suite delta, smoke summary, ADRs M12-01..02 reference, what's open, what's next (M13).
- `CLAUDE.md` + `AGENTS.md` — bump state-doc pointer to the M12 close-out; verify byte-identical mirror.
- `docs/08-roadmap/backlog/post-phase-13-4.md` — refresh "Last sync" line; M12 introduces no new backlog items (it closes nothing either — M12 is roadmap discipline, not a backlog burndown).
- `docs/06-testing/testing-log.md` — append entry covering scope, smoke result, suite delta.
