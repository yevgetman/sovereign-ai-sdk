...
- `docs/06-testing/semantic-testing.md` — inventory increment + new run-policy rows + new section.
...
- Modify: `docs/06-testing/semantic-testing.md` (inventory + new section + run-policy rows)
...
- [ ] **Step 3: Update `docs/06-testing/semantic-testing.md`**
...
```bash
git add tests/semantic/suites/19-review.cases.ts docs/06-testing/semantic-testing.md
git commit -m "$(cat <<'EOF'
...
```bash
git add CLAUDE.md docs/06-testing/testing-log.md
git commit -m "$(cat <<'EOF'
...
**Plan complete and saved to `plans/2026-05-06-phase-13-3-background-review-daemon.md`.**
