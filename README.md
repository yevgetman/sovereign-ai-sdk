...
**Current state (2026-05-08).** Phases 0 through 13.4 are shipped. The next canonical build-plan phase is **Phase 13.5** (scheduled-mission sub-agents). The post-13.4 backlog has 4 open items left (`12`, `13`, `17`, `24`), all P3/P4 and non-blocking. Current unit baseline is 1717/1717; semantic baseline remains 58/58.
...
**Next high-leverage target** per the build plan: **Phase 13.5** (scheduled-mission sub-agents — mission-dir contract, loader/writer, and `--state-dir` coupling). See `~/code/sovereign-ai-docs/harness/docs/runtime/harness-build-plan.md` for the full plan.
